...
var Model = /** @class */function () {
  ...
  Model.prototype.set = function (userProps) {
...
},{"axios":"node_modules/axios/index.js","./Eventing":"src/models/Eventing.ts"}],"src/models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
var Attributes = /** @class */function () {
  function Attributes(data) {
    var _this = this;
    this.data = data;
    //* Both methods help read or change user data
...
var User = /** @class */function (_super) {
  ...
  User.buildUser = function (attr) {
    return new User(new Attributes_1.Attributes(attr), new Eventing_1.Eventing(), new ApiSync_1.ApiSync('http://localhost:3000/users'));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
var UserForm = /** @class */function (_super) {
  ...
  function UserForm() {
    ...
    _this.onChangeName = function () {
      var newName = _this.parent.querySelector('input').value;
      _this.model.set({
        name: newName
      });
    };
    _this.onChangeAge = function () {
...
userEdit.render();
},{"./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
